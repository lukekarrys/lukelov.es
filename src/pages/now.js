...
const NotFoundPage = () => (
  <Layout>
    ...
    <p>
      <a href="https://livefromquarantine.club">livefromquarantine.club</a> – Some musicians I like have been doing daily or weekly streams from home so I built this site to make it easy to jump between songs in different videos. (Over-)engineering the automated data pipeline for <a href="https://livefromquarantine.club/bengibbard">multiple</a> <a href="https://livefromquarantine.club/benfolds">artists</a> has been a fun distraction right now. I also want to use it as an excuse to build a fully typed state machine, but that might be too much to ask on distraction side project.
    </p>
    ...
    <p><a href="https://lukecod.es">lukecod.es</a> &amp; <a href="https://lukelov.es">lukelov.es</a> – I moved both these site to Gatsby and Netlify. It's pretty great to have an all JavaScript build process on them and I love Netlify deploy previews. I did a little experiment between the default Gatsby, no-js Gatsby, and Turbolinks Gatsby and got to test them all side by side.</p>
  </Layout>
)
