...
const NotFoundPage = () => (
  <Layout>
    <SEO title="Now" />
    <h1>Here's what I'm up to right now (updated 2020-11-22):</h1>
    <p>
    ...
    <p>
      <a href="https://resume.lukekarrys.com/pdf">my pdf resume</a> – I like
      editing my resume in Markdown but it's always helpful to have it as a PDF
      so I built the PDF generation with Playwright as part of the build
